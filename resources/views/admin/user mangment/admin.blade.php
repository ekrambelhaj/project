					...
					<div class="col-12 p-0 main-box shadow">
						...
						<div class="col-12 p-3">
							<div class="col-12 py-2 px-0 d-flex justify-content-center">
									<img src="" style="width:150px;max-width: 100%;border-radius: 50%;" id="getUserAvatar">
							</div>
                            <div class="col-12 p-2">
                                ...
                                <div class="col-12 pt-3">
                                    <input type="file" name=""  class="form-control" value="" id="avatar-image">
							...
							<div class="col-12 p-2">
								...
								<div class="col-12 pt-3">
									<input type="text" name="name" required min="3" max="190" class="form-control" value="" accept="image/*">
								</div>
							</div>
                            <div class="col-12 p-2">
                                <div class="col-12">
                                ...
                                <div class="col-12 pt-3">
                                    <textarea class="form-control" name="bio" style="min-height:150px"></textarea>
                                </div>
                            </div>
                    ...
                    <div class="col-12 p-0 main-box shadow">
                        ...
                        <div class="col-12 p-3">
                            <div class="col-12 p-2">
                                ...
                                <div class="col-12 pt-3">
                                    <input type="email" name="old_email" class="form-control" required value="">
                                </div>
                            </div>
